			...
			<div class="test">
				<form action="" method="post">
					<div class="test_title">
						...
						<c:if test="${test.singleQuestionNum !=0 }">
						<div class="test_content">
							<div class="test_content_title">
								<h2>单选题</h2>
								<p>
									<span>共</span><i class="content_lit">${test.singleQuestionNum }</i><span>题，</span><span>合计</span><i class="content_fs">${singleScore * test.singleQuestionNum}</i><span>分</span>
								</p>
							</div>
						</div>
											...
											<ul>
													...
													<li class="option" data-type="single" data-value="A">
														...
														<label for="${singleQuestion }_answer_${sq.id}_option_1">
															A.
															<p class="ue" style="display: inline;">${sq.question.optionA }</p>
														</label>
													</li>
													...
													<li class="option" data-type="single" data-value="B">
														...
														<label for="${singleQuestion }_answer_${sq.id}_option_2">
															B.
															<p class="ue" style="display: inline;">${sq.question.optionB }</p>
														</label>
													</li>
													...
													<li class="option" data-type="single" data-value="C">
														...
														<label for="${singleQuestion }_answer_${sq.id}_option_3">
															C.
															<p class="ue" style="display: inline;">${sq.question.optionC }</p>
														</label>
													</li>
													...
													<li class="option" data-type="single" data-value="D">
														...
														<label for="${singleQuestion }_answer_${sq.id}_option_4">
															D.
															<p class="ue" style="display: inline;">${sq.question.optionD }</p>
														</label>
													</li>
						...
						<c:if test="${test.muiltQuestionNum !=0 }">
						<div class="test_content">
							<div class="test_content_title">
								<h2>多选题</h2>
								<p>
									<span>共</span><i class="content_lit">${test.muiltQuestionNum }</i><span>题，</span><span>合计</span><i class="content_fs">${test.muiltQuestionNum * muiltScore}</i><span>分</span>
								</p>
							</div>
						</div>
						<div class="test_content_nr">
											...
											<ul>
													...
													<li class="option" data-type="muilt" data-value="A">
														...
														<label for="${muiltQuestion }_answer_${mq.id}_option_1">
															A.
															<p class="ue" style="display: inline;">${mq.question.optionA}</p>
														</label>
													</li>
													...
													<li class="option" data-type="muilt" data-value="B">
														...
														<label for="${muiltQuestion }_answer_${mq.id}_option_2">
															B.
															<p class="ue" style="display: inline;">${mq.question.optionB}</p>
														</label>
													</li>
													...
													<li class="option" data-type="muilt" data-value="C">
														...
														<label for="${muiltQuestion }_answer_${mq.id}_option_3">
															C.
															<p class="ue" style="display: inline;">${mq.question.optionC}</p>
														</label>
													</li>
													...
													<li class="option" data-type="muilt" data-value="D">
														...
														<label for="${muiltQuestion }_answer_${mq.id}_option_4">
															D.
															<p class="ue" style="display: inline;">${mq.question.optionD}</p>
														</label>
													</li>
					...
					<c:if test="${test.chargeQuestionNum !=0 }">
						<div class="test_content">
							<div class="test_content_title">
								<h2>判断题</h2>
								<p>
									<span>共</span><i class="content_lit">${test.chargeQuestionNum }</i><span>题，</span><span>合计</span><i class="content_fs">${chargeScore * test.chargeQuestionNum}</i><span>分</span>
								</p>
							</div>
						</div>
						<div class="test_content_nr">
											...
											<ul>
													...
													<li class="option" data-type="charge" data-value="A">
														...
														<label for="${chargeQuestion }_answer_${cq.id}_option_1">
															A.
															<p class="ue" style="display: inline;">${cq.question.optionA }</p>
														</label>
													</li>
													...
													<li class="option" data-type="charge" data-value="B">
														...
														<label for="${chargeQuestion }_answer_${cq.id}_option_2">
															B.
															<p class="ue" style="display: inline;">${cq.question.optionB }</p>
														</label>
													</li>
											</ul>
										</div>
			...
			<div class="nr_rt_main">
				<div class="rt_nr1">
					<div class="rt_nr1_title">
						<h1>
							<span style="font-size:18px;">剩余答题时间</span>
						</h1>
						<p class="test_time">
...
<script>
	...
	$(function() {
		$('li.option input').click(function() {
			var testId = $(this).closest('.test_content_nr_main').closest('li').attr('id'); // 得到题目ID
			var cardLi = $('a[href=#' + testId + ']'); // 根据题目ID找到对应答题卡
			// 设置已答题
			if(!cardLi.hasClass('hasBeenAnswer')){
				cardLi.addClass('hasBeenAnswer');
			}
			var testArr = testId.split('_');
			var questionId = testArr[2];
			var submitTestId = ${test.id};
			var testPaperId = ${testPaper.id};
			var answerQuestionId = $("#"+testId).attr("data-key");
			...
			$.ajax({
				...
				url: "submit_answer",
				dataType: "json",
				data: {"testId":submitTestId,testPaperId:testPaperId,questionId:questionId,answer:selectedAnswer,id:answerQuestionId},
...
function autoSubmitExam(){
	...
	$.ajax({
		...
		url: "submit_exam",
		dataType: "json",
		data: {"testId":'${test.id}',examPaperId:'${testPaper.id}'},
		success: function(data){
			if(data.type == 'success'){
...
function submitExam(){
	...
	$.ajax({
		...
		url: "submit_exam",
		dataType: "json",
		data: {"testId":'${test.id}',testPaperId:'${testPaper.id}'},
		success: function(data){
			if(data.type == 'success'){
