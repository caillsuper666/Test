    ...
    <script type="text/javascript">
	 var _menus = {"menus":[
						{"menuid":"1","icon":"","menuname":"用户管理",
							"menus":[
									{"menuid":"11","menuname":"用户列表","icon":"","url":"../user/list"},
								]
						},
						{"menuid":"3","icon":"","menuname":"科目管理",
							"menus":
									{"menuid":"31","menuname":"科目列表","icon":"","url":"../subject/list"},
								]
						},
						{"menuid":"4","icon":"","menuname":"题库管理",
							"menus":[
									{"menuid":"41","menuname":"题库列表","icon":"","url":"../question/list"},
								]
						},
						{"menuid":"2","icon":"","menuname":"考试信息管理",
							"menus":[
									{"menuid":"21","menuname":"考试列表","icon":"icon-user-student","url":"../test/list"},
								]
						},
				]};
    </script>
